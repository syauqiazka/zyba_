...
export default function AssessmentPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      <header className="w-full bg-white border-b border-brown-900/10 px-6 py-4 flex items-center justify-between sticky top-0 z-30 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="ml-2 text-[10px] font-bold text-orange-500 bg-orange-100 px-2 py-0.5 rounded-full uppercase tracking-wider">
              Asesmen Awal
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2">
            <div className="w-40 h-2 rounded-full bg-cream border border-brown-900/10 overflow-hidden">
              <div
          ...
          {/* Lock badge — beri tahu user kenapa tidak bisa akses fitur lain */}
          {!isCompleted && (
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-cream border border-brown-900/15 text-[11px] font-bold text-brown-700">
      ...
      <div className="flex-1 max-w-[1200px] w-full mx-auto px-6 py-8 md:px-10 md:py-10">
        ...
        <div className="grid grid-cols-12 gap-8 items-start">
          ...
          <div
            className={`${
              isCompleted || isCompiling ? "col-span-12" : "col-span-8"
            } glass-card rounded-3xl p-8 border border-brown-900/10 flex flex-col justify-between min-h-[500px] bg-white`}
          >
