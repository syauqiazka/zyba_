...
const config = {
  ...
  "inlineSchemaHash": "282c324da06715942573f1984260f9741ac0f2a18022c54f96cd8a5f6edf5976",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/generated/account-client/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/generated/account-client/libquery_engine-rhel-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/generated/account-client/schema.prisma")
